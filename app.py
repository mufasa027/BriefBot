...
if st.session_state.role_selected is None:
    ...
    with hdr_col2:
        ...
        <div class="app-header" style="border-bottom: none; padding-bottom: 0; margin-bottom: 0;">
            <div>
                <h1 class="app-title">CIPHERBRIEF <span style="font-size: 0.4em; color: var(--text-muted); vertical-align: top;">v1.1</span></h1>
    ...
    with st.sidebar:
        ...
        <div class="sidebar-brand-subtitle">NEWS INTELLIGENCE v1.1</div>
